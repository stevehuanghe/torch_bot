...
def get_transforms(new_size=None, height=128, width=128, mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225],
                   center_crop=False, crop=True, flip=True):
...
def load_word_embeddings(emb_file, vocab, wv_type='glove.840B', wv_dir='./data/glove', wv_dim=300):
    URL = {
